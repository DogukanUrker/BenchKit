...
or 6 for DNS/connect failures, with 0.5s doubling up to 8s, plus jitter). When
...
`BENCHKIT_CONNECT_RETRIES`,
`BENCHKIT_RETRY_BASE_DELAY`, `BENCHKIT_RETRY_MAX_DELAY`, and
`BENCHKIT_RETRY_MAX_WAIT`; set both retry counts to `1` to disable retries.

"""WinoGrande benchmark - binary commonsense pronoun resolution."""
...
DATASET = Path(__file__).parent.parent / "datasets" / "winogrande.jsonl"

SYSTEM = (
    "Choose the option that best replaces the underscore in the sentence. "
